object Dmconexcao: TDmconexcao
  ...
  object SQLDataSet2: TSQLDataSet
    CommandText = 
      'select distinct '#13#10'    new_table.dta_vencimento,'#13#10'    tipo_apolic' +
      'e.nome,'#13#10'    new_table.nome_segurado,'#13#10'    new_table.telefone,'#13#10 +
      '    new_table.dta_contrato'#13#10'from new_table'#13#10'   inner join tipo_a' +
      'police on (new_table.tipo_apolice = tipo_apolice.sigla)'#13#10'order b' +
      'y new_table.dta_vencimento, tipo_apolice.nome, new_table.nome_se' +
      'gurado, new_table.telefone, new_table.dta_contrato'
    MaxBlobSize = -1
    Params = <>
    SQLConnection = SQLConnection1
    Left = 24
